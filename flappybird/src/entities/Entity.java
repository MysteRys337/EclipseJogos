...
public class Entity {
	...
	public static BufferedImage PIPE          = Game.spritesheet.getSprite(107, 0, 26, 160);
	public static BufferedImage PIPE_REVERSED = Game.spritesheet.getSprite(133, 0, 26, 160);
	...
	protected void renderMask(Graphics g) {
		...
		g.fillRect((int)x + maskX, (int)y + maskY, width, height);
	}
}
